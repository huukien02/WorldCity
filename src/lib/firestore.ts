...
export const chunkDoc = (chunkId: string) =>
  d<MapChunkDoc>("mapChunks", chunkId);
...
export const listingDoc = (id: string) =>
  d<MarketListingDoc>("marketplace", id);
...
// ── Weather ──────────────────────────────────────────────────────────────────
import type { WeatherDoc } from "@/features/weather/types";
export const weatherDoc = () => d<WeatherDoc>("game", "weather");
